...
![Настройка Custom-бота](images/custom-bot-settings.png)

Настройка уведомлений — выберите созданного бота в качестве средства для отправки и укажите получателя:

![Настройка уведомлений](images/notification-settings.png)
...
- **Ответ при ошибке:** `{"ok": false, "error": "Описание ошибки."}` (см. [Коды ответов](#коды-ответов))
...
![Пример принятого сообщения](images/message-json.png)
